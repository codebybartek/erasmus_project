...
class User
{
	...
	public function fetch_all(){
		...
		$query = $pdo->prepare("SELECT users.name_user, users.email_user_user,roles.name_role FROM users INNER JOIN roles ON roles.id_role=users.id_role
");
		$query->execute();
	...
	public function fetch_data($id){
		global $pdo;
		$query = $pdo->prepare("SELECT users.name_user, users.email_user_user,roles.name_role users INNER JOIN roles ON roles.id_role=users.id_role WHERE id_user = :id_user");
